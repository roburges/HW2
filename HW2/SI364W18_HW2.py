...
def artistinfo():
	if request.method=="GET":
		...
		return render_template('artist_info.html', objects = objects, results=objects)
...
def specificsong(artist_name):
	# pardict = {'term': artistName, 'entity': 'trackName', 'media': 'music'}
	retrieve_url="https://itunes.apple.com/search" + artist_name
	retrieve=requests.get(retrieve_url)
	formatting=retrieve.text
	results=formatting.json()['results']
